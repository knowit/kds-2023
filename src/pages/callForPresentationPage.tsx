      ...
      <Grid container justifyContent={'center'}>
        ...
        <Grid item>
          <Typography variant='body1'>
            This page is for submitting presentations for the conference. If you
            submit a presentation, you do not need to go through regular
        ...
        <Grid item>
          <Typography variant='body1'>
            ...
            shared between companies, as well as provide excellent opportunities
            for members to get into the public world of conferences.
          </Typography>
        </Grid>
        <Grid item>
          <Typography variant='body1'>
            We accept a broad range of topics as long as centered around
            development – and remember, that is a truly broad topic. As this is
            an internal conference in which all attendees are Knowit employees,
            you may be freer to discuss experiences and insights from projects.
            Is there a talk you wish to submit to a larger event that you would
            like to test run? Maybe get some more mileage out of your master
            thesis, or get an opportunity to talk about that really cool side
            project you’ve been deeply involved in?
          </Typography>
        </Grid>
        <Grid item>
          <Typography variant='body1'>
            ...
            schedule will be made public around the beginning of November. There
            are three tiers of presentations you may submit. Please pick the one
        ...
        <Grid item>
          <Typography variant='body1'>
            ...
            This is for quickly elaborating on an idea, showing a technique, or
            taking a stand on a topic. Things have to move rapidly, so no time
        ...
        <Grid item>
          <Typography variant='body1'>
            ...
            for user stories, more in-depth on a topic, and general exploration.
            It’s up to you how you would like to balance presentations versus
            Q/A with the audience, but at least 20 minutes should be the
            presentation.
          </Typography>
        </Grid>
        <Grid item>
          <Typography variant='body1'>
            ...
            all stories are easily told and require extra time. Maybe there is a
            unique problem you’ve worked with that need some background
            information, some technical topic that requires some onboarding, or
            just a topic that you plain want to go really into depth in.
          </Typography>
        </Grid>
        <Grid item>
          <Link
